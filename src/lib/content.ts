...
const posts: PostMeta[] = [
  // ── Redeem Codes ──────────────────────────────────
  {
    ...
    codes: [
      { code: "FFWS2026MARCH", reward: "2x Diamond Royale Voucher", status: "active" },
      { code: "FFGLOBAL2026X", reward: "Winterlands Weapon Loot Crate", status: "active" },
      { code: "FF10THSPECIAL", reward: "10th Anniversary Bundle", status: "new" },
      { code: "FFREWARD2026A", reward: "50 Diamonds", status: "expired" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "BGMIMARCH2026", reward: "Supply Crate Coupon x3", status: "active" },
      { code: "TQIZBZ76F", reward: "Premium Outfit Set", status: "active" },
      { code: "BMTFZBZQNK", reward: "AG Currency x100", status: "new" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "CODM2026MARCH", reward: "Weapon XP Card x5", status: "active" },
      { code: "BFQGZEBKCAZ", reward: "Razorback Skin", status: "active" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "GS6RLKGKWUER", reward: "60 Primogems + 5 Adventurer's EXP", status: "active" },
      { code: "2SRKDU8TY4KM", reward: "30 Primogems + 10000 Mora", status: "new" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "HSR2026MARCH", reward: "50 Stellar Jade + 10000 Credits", status: "active" },
      { code: "STARRAILGIFT", reward: "Traveler's Guide x3", status: "active" },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      { type: "paragraph", html: "<strong>PUBG Mobile</strong> redeem codes offer players free <strong>AG currency, UC, weapon skins, outfits, and supply crate coupons</strong>. Tencent and Krafton distribute these codes through official social media, esports events like <strong>PMGC, PMSL, and PEL</strong>, and seasonal celebrations." },
      ...
      { type: "table", headers: ["Reward Type", "Examples", "Rarity"], rows: [
        ...
        ["<strong>Supply Crate Coupons</strong>", "Classic/Premium Crate x3-5", "Common"],
        ["<strong>RP Vouchers</strong>", "Royale Pass point vouchers", "Uncommon"],
      ]},
      ...
      { type: "callout", variant: "tip", html: "Anniversary events (usually in March) offer the <strong>most generous codes</strong> with rare skins and UC rewards." },
      ...
      { type: "heading", level: 2, text: "PUBG Mobile Code Rules" },
      { type: "table", headers: ["Rule", "Details"], rows: [
        ["Uses per account", "<strong>1 use per code</strong> per Character ID"],
        ["Reward delivery", "<strong>Minutes to 24 hours</strong> via mailbox"],
        ["Guest accounts", "<strong>Not supported</strong> — must link social account"],
        ["Server restrictions", "Some codes are <strong>region-specific</strong>"],
        ["Code expiry", "Usually <strong>24-72 hours</strong>"],
      ]},
    ...
    codes: [
      { code: "PUBGMARCH2026", reward: "AG Currency x200", status: "active" },
      { code: "PUBGSPRING26A", reward: "Classic Crate Coupon x3", status: "active" },
      { code: "TQIZBZ76FPUB", reward: "Glacier M416 Skin (3d)", status: "new" },
      { code: "PUBGSKIN2026X", reward: "Premium Outfit Set", status: "expired" },
    ],
    faqs: [
      { question: "How to redeem PUBG Mobile codes?", answer: "Visit the official PUBG Mobile Redemption Center at pubgmobile.com/redeem, log in with your account, enter the code, and click Redeem. Rewards arrive in your in-game mailbox within 24 hours." },
      { question: "Why is my PUBG Mobile code not working?", answer: "Codes may be expired, region-locked, or already claimed. Ensure you're entering the code exactly as shown including capitalization. Some codes only work on specific servers." },
  ...
  },
  {
    ...
    codes: [
      { code: "WUWASPRING26", reward: "80 Astrite + 10000 Shell Credits", status: "active" },
      { code: "WUWA2026GIFT", reward: "Premium Resonance Potion x5", status: "active" },
      { code: "KUROHNY2026M", reward: "Advanced Synthesis Module x3", status: "new" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "ZZZ2026MARCH", reward: "60 Polychrome + 20000 Dennies", status: "active" },
      { code: "ZZZGIFTMAR26", reward: "Senior Investigator Log x5", status: "new" },
    ],
    faqs: [
  ...
  },
  {
    ...
    sections: [
      ...
      { type: "table", headers: ["Reward Type", "Examples", "Rarity"], rows: [
        ...
        ["<strong>Lucky Spin Tickets</strong>", "Spins for skins/heroes", "Uncommon"],
      ]},
      ...
      { type: "list", style: "bullet", items: [
        ...
        "Follow <strong>regional MLBB pages</strong> — some codes are region-specific (SEA, LATAM, etc.).",
      ]},
      ...
      { type: "heading", level: 2, text: "MLBB Code Rules" },
      { type: "table", headers: ["Rule", "Details"], rows: [
        ["Uses per account", "<strong>1 use per code</strong> per Game ID"],
        ["Reward delivery", "<strong>Instant</strong> to in-game mailbox"],
        ["Account requirement", "Must have a <strong>Moonton account</strong>"],
        ["Region restrictions", "Some codes are <strong>region-specific</strong>"],
        ["Code expiry", "Usually <strong>3-7 days</strong>"],
      ]},
    ...
    codes: [
      { code: "MLBB2026MARCH", reward: "500 Diamonds", status: "active" },
      { code: "MLBBGIFTX26A", reward: "Rare Skin Fragment x5", status: "active" },
      { code: "MLBBSPRING26", reward: "Trial Card: Epic Skin (3d)", status: "new" },
    ],
    faqs: [
  ...
  },
  {
    ...
    codes: [
      { code: "HI3MAR2026AB", reward: "200 Crystals + 5 Stamina Potions", status: "active" },
      { code: "HI3SPRING26G", reward: "Ancient Willpower x30", status: "new" },
    ],
    faqs: [
  ...
  // ── Gaming Gear ───────────────────────────────────
  {
    ...
    affiliateLinks: [
      { label: "Razer DeathAdder V3 Pro", url: "#", price: "$89", platform: "Amazon" },
      { label: "Logitech G Pro X Superlight 3", url: "#", price: "$159", platform: "Amazon" },
    ],
  },
  {
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Artisan FX Zero Soft XL", url: "#", price: "$59", platform: "Amazon" },
      { label: "Lethal Gaming Gear Saturn Pro", url: "#", price: "$30", platform: "Amazon" },
      { label: "SteelSeries QcK Heavy XXL", url: "#", price: "$25", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Secretlab Titan Evo Lite", url: "#", price: "$289", platform: "Amazon" },
      { label: "HON Ignition 2.0", url: "#", price: "$250", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Razer Hammerhead Pro HyperSpeed", url: "#", price: "$149", platform: "Amazon" },
      { label: "Samsung Galaxy Buds3 Pro", url: "#", price: "$179", platform: "Amazon" },
      { label: "KZ ZSN Pro X (Wired)", url: "#", price: "$18", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Elgato Facecam Pro 2", url: "#", price: "$249", platform: "Amazon" },
      { label: "Logitech C920x", url: "#", price: "$59", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Xbox Elite Series 3", url: "#", price: "$179", platform: "Amazon" },
      { label: "DualSense Edge", url: "#", price: "$199", platform: "Amazon" },
      { label: "8BitDo Ultimate 2.4G", url: "#", price: "$49", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "AMD Ryzen 5 7600", url: "#", price: "$179", platform: "Amazon" },
      { label: "RX 7700 XT 12GB", url: "#", price: "$329", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "AMD Ryzen 7 9700X", url: "#", price: "$299", platform: "Amazon" },
      { label: "RTX 5070 Ti 16GB", url: "#", price: "$549", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "RTX 5080 16GB", url: "#", price: "$799", platform: "Amazon" },
      { label: "AMD Ryzen 9 9900X", url: "#", price: "$399", platform: "Amazon" },
      { label: "Corsair 6000D Airflow", url: "#", price: "$159", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Black Shark Magnetic Cooler 5 Pro", url: "#", price: "$39", platform: "Amazon" },
      { label: "GameSir X4 Aileron Controller", url: "#", price: "$69", platform: "Amazon" },
      { label: "Flydigi Wasp 2 Elite Triggers", url: "#", price: "$25", platform: "Amazon" },
    ],
    faqs: [
  ...
  // ── Deals ─────────────────────────────────────────
  {
    ...
    affiliateLinks: [
      { label: "Logitech G502 X — 40% off", url: "#", price: "$47", platform: "Amazon" },
      { label: "HyperX Cloud III — 30% off", url: "#", price: "$69", platform: "Amazon" },
    ],
  },
  {
    ...
    affiliateLinks: [
      { label: "ASUS VG27AQ1A 27\" 1440p 170Hz — 35% off", url: "#", price: "$219", platform: "Amazon" },
      { label: "Razer BlackWidow V4 75% — 25% off", url: "#", price: "$112", platform: "Amazon" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "iQOO Neo 10 Pro — ₹4,000 off", url: "#", price: "₹31,999", platform: "Flipkart" },
      { label: "Cosmic Byte GS430 Headset — 40% off", url: "#", price: "₹599", platform: "Flipkart" },
      { label: "Redgear Pro Controller — 30% off", url: "#", price: "₹999", platform: "Flipkart" },
    ],
    faqs: [
  ...
  },
  {
    ...
    affiliateLinks: [
      { label: "Lenovo Legion 5i — RTX 4060, 144Hz", url: "#", price: "$849", platform: "Amazon" },
      { label: "ASUS TUF Gaming A16 — RTX 5060, 165Hz", url: "#", price: "$949", platform: "Amazon" },
      { label: "Acer Nitro V 15 — RTX 4060, 144Hz", url: "#", price: "$749", platform: "Amazon" },
    ],
    faqs: [
